...
class administrator extends Admin {
	...
	public function indexAction() {
	    $list   = $this->db->setTableName('admin')->getAll(null, null, array('userid', 'username','password','realname','roleid'));
	...
	public function delAction() {
	    ...
	    if (Session::get('user_id') == $userid) $this->show_message('自己不能删除自己',2);
