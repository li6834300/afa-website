...
<div class="subnav">
	<div class="content-menu">
		<div class="left">
		<a href="<?php echo url('content/index', array('catid'=>$catid, )); ?>" class="on"><em><?php if(empty($catid)) echo '全部内容'; else { echo $this->category_cache[$catid]['catname'];} ?></em></a>
	...
	<div class="bk10"></div>
		...
		<tr >
			...
			<input type="button"  class="button" value="删除" name="delete" onClick="confirm_delete()" >&nbsp;
