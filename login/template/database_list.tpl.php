...
<div class="subnav">
	<div class="content-menu">
		<a href="<?php echo url('database/import'); ?>" class="on"><em>数据库恢复</em></a>
	</div>
	<div class="bk10"></div>
...
<thead class="table-thead">
	...
	<td align="left"><input <?php if ($v['xiaosys']) echo 'class="selectform"';?> type="checkbox" name="table[]" value="<?php echo $v['Name']?>"/>
	  <?php if ($v['xiaosys']) echo '<font color="#c00">系统表</font>'; else echo '<font color="#369">其他系统表</font>';?></td>
	...
	?>
    <tr >
	<td colspan="6" align="left">选择系统表&nbsp;&nbsp;<input name="selectform" class="cselectform" type="checkbox" onClick="setdb()">
