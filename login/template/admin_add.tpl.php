...
<tbody>
    ...
    <tr height="25">
		<td align="left">
		<input name="auth[keylink-index]" value="1" id="c_keylink" type="checkbox" onClick="setC('keylink')" <?php if ($auth['keylink-index']) echo 'checked' ?>>关键字内链</td>
        
		<td align="left">
				<input class="c_keylink" name="auth[keylink-add]" type="checkbox" value="1" <?php if ($auth['keylink-add']) echo 'checked' ?> ><span>添加</span>
				<input class="c_keylink" name="auth[keylink-edit]" type="checkbox" value="1" <?php if ($auth['keylink-edit']) echo 'checked' ?> ><span>编辑</span>
				<input class="c_keylink" name="auth[keylink-del]" type="checkbox" value="1" <?php if ($auth['keylink-del']) echo 'checked' ?> ><span>删除</span>
		</td>
	</tr>
	...
	<tr height="25">
		<td align="left">
		<input name="auth[sitemap-index]" value="1" id="c_sitemap" type="checkbox" onClick="setC('sitemap')" <?php if ($auth['sitemap-index']) echo 'checked' ?>>生成sitemap</td>
...
&nbsp;
    ...
    <tr height="25">
		<td align="left">
		<input name="auth[uploadfile-manager]" value="1" id="c_uploadfile" type="checkbox" onClick="setC('uploadfile')" <?php if ($auth['uploadfile-manager']) echo 'checked' ?>>附件管理</td>
        
		<td align="left">
<input class="c_uploadfile" name="auth[uploadfile-del]" type="checkbox" value="1" <?php if ($auth['uploadfile-del']) echo 'checked' ?>><span>删除</span>
		</td>
	</tr>
	<tr height="25">
		<td align="left">
