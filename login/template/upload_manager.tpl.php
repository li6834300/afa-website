...
<div class="subnav">
		<table width="100%"  class="m-table" id="imgPreview">
		...
		<tr><td align="left"><a href="<?php echo $pdir; ?>"><img src="./img/folder-closed.gif">返回上一层目录</a></td>
        <td>&nbsp; </td>
        </tr>
		<?php } ?>
        ...
        <td><a href="<?php echo $t['url']; ?>">[打开]</a> </td>
		</tr>
		<?php } ?>
		...
		&nbsp;<a href="javascript:;" rel="<?php echo SITE_PATH.$dir;  echo $t['name']; ?>" title="<?php echo $t['name']; ?>"><?php echo $t['name']; ?></a></td>
         ...
         <a  href="javascript:confirmurl('<?php echo url('uploadfile/del');?>&del=<?php echo SITE_PATH.$dir;  echo $t['name']; ?>','确定删除 『<?php echo $t['name']; ?> 』图片吗？')" >删除</a> 
          </td>
		</tr>
		<?php } ?>
