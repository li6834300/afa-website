...
<div class="subnav">
	...
	<div class="bk10"></div>
		...
		<thead class="table-thead">
                    ...
                    <?php if ($dir !='' ):?>
                        <tr>
                            <td align="left" colspan="3"><a href="<?php if (urldecode(dirname($dir)) =='.')  echo url('template') ; else echo url('template', array('dir'=>urldecode(dirname($dir).DS))) ;?>" >
                    ...
                    if(is_array($list)):
     					...
     					foreach($list as $v):
                            $filename = basename($v);
							if (is_dir($v))
                            echo '<tr><td align="left"><img src="./img/folder-closed.gif" /> <a href="?c=template&dir='.urldecode($dir.$filename.DS).'">'.$filename.'</a></td><td align="left"><input type="text" class="input-text" name="file_explan['.$encode_local.']['.$filename.']" value="'.(isset($file_explan[$encode_local][$filename]) ? $file_explan[$encode_local][$filename] : "").'"></td><td></td> </tr>';
                        endforeach;
