...
<div class="subnav">
	<div class="content-menu">
		<a href="#" class="on"><em><?php echo $this->model['modelname'] ?></em></a>
	...
	<div class="bk10"></div>
		...
		<?php } } ?>
			...
			<div class="pageleft">
			<input type="button" class="button" value="删除" name="submit_del" onClick="confirm_delete()">&nbsp;
            ...
            <input type="submit" class="button" value="导出Excel" name="submit_status_3" onClick="$('#list_form').val('excel')">&nbsp;
		</div>
