...
DROP TABLE IF EXISTS `xiao_weixinmenu`;
CREATE TABLE `xiao_weixinmenu` (
...
DROP TABLE IF EXISTS `xiao_keylink`;
CREATE TABLE IF NOT EXISTS `xiao_keylink` (
...
DROP TABLE IF EXISTS `xiao_member_connect`;
CREATE TABLE IF NOT EXISTS `xiao_member_connect` (
...
(2, 2, 'content', '内容', 1, '', '', '', 'editor', 'a:4:{s:7:"toolbar";s:1:"1";s:5:"width";s:3:"700";s:6:"height";s:3:"450";s:12:"defaultvalue";s:0:"";}', 0, 0),
