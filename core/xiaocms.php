...
xiaocms::load_file(CORE_PATH . 'library' . DS . 'function.php');
...
abstract class xiaocms {
	...
	public static function run() {
		...
		if (is_file(CONTROLLER_DIR . $controller . '.php')) {	
			...
			exit('Prompt：Controller does not exist.');
		}
		$object = new $controller();
		if (method_exists($controller, $action)) {
			$object->$action();
		} else {
			exit('Prompt：Action does not exist.');
		}
	}
    ...
    private static $_classMap = array(
    	'QC' => 'qqlogin.class.php',
    	'URL' => 'qqlogin.class.php',
    	'Oauth' => 'qqlogin.class.php',
    	'Recorder' => 'qqlogin.class.php',
    );
