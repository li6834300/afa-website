...
class uploadfile extends Member {
    
    protected $dir;
    
    public function __construct() {
		parent::__construct();
		$dir = 'data/upload/member/'.$this->member_info['id'] . '/';
        $this->dir = $dir;
$config = <<<EOT
/* 前后端通信相关的配置,注释只允许使用多行方式 */
{
    ...
    "imageCompressBorder": 1920, /* 图片压缩最长边限制 */
    ...
    "filePathFormat": "$dir/file/{yyyy}{mm}{dd}/{time}{rand:6}", /* 上传保存路径,可以自定义保存路径和文件名格式 */
...
EOT;
     ...
     * 文件上传
     */
    private function upload($fields, $type, $size = 20) {
